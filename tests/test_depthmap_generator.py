...
class DepthMapGeneratorCoverageTests(unittest.TestCase):
    def test_unlisted_depthmap_page_uses_client_side_inference(self):
        ...
        self.assertLess(page.index('id="depth_swatch_grid"'), page.index('id="depth_workspace"'))
        self.assertLess(page.index('id="depth_workspace"'), page.index('id="depth_generate"'))
        ...
        self.assertLess(page.index('id="depth_processing_error"'), page.index('id="depth_near"'))
