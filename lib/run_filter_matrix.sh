...
filters=(none wave voronoi shear spiral mosaic crystal ripple centerline glitch deep_fryer shattered holographic)
...
declare -A filter_json=(
  ...
  [centerline]='{"dark_threshold":145,"contrast":1.15,"blur":1,"gap_closure":1,"line_simplification":0.35,"min_branch_length":8,"stroke_width":0.35}'
  ...
  [holographic]='{"band_height":12,"segment_width":54,"gap":0.6,"diffraction":18,"phase_stride":1.35,"echo_count":2,"echo_spacing":5,"density":0.78,"setting_name":"holographic","light_threshold":150,"invert_threshold":false,"seed":1}'
)
