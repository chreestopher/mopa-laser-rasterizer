...
filters=(none wave voronoi shear spiral mosaic crystal ripple centerline glitch deep_fryer shattered holographic_space)
...
declare -A filter_json=(
  ...
  [holographic_space]='{"band_height":12,"segment_width":54,"gap":0.6,"diffraction":18,"phase_stride":1.35,"echo_count":2,"echo_spacing":5,"density":0.78,"setting_name":"holographic","light_threshold":150,"seed":1}'
)
