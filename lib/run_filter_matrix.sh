...
filters=(none wave voronoi shear spiral mosaic crystal ripple centerline glitch deep_fryer shattered sacred)
...
declare -A filter_json=(
  ...
  [sacred]='{"grating_spacing":1.25,"line_width":0.3,"field_scale":60,"field_strength":0.35,"symmetry":6,"base_angle":0,"step_size":0.75,"seed":1,"keep_black":false}'
)
