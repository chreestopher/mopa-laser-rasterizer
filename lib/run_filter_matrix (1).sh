...
filters=(none wave voronoi shear spiral mosaic crystal ripple centerline tumbler xenoglyph)
...
declare -A filter_json=(
  ...
  [xenoglyph]='{"recognizability":0.65,"glyph_density":0.55,"symmetry_order":6,"signal_rings":4,"circuit_branching":0.5,"angular_strangeness":0.65,"void_ratio":0.18,"artifact_age":0.15,"signal_seed":1,"core_x":0.5,"core_y":0.5,"light_areas_transparent":true,"light_threshold":225}'
)
