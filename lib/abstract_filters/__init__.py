from . import centerline, crystal, deep_fryer, glitch, holographic, mosaic, ripple, shattered, shear, spiral, voronoi, wave
...
MODULES={
    ...
    "deep_fryer":deep_fryer,"holographic":holographic,
}
ALIASES={"tessellation":"crystal","triangles":"crystal","topographic":"ripple","xenoglyph":"shattered","alien":"shattered","holographic_space":"holographic"}
FULL_PALETTE_FILTERS={"wave","voronoi","shear","spiral","mosaic","crystal","ripple","glitch","shattered","deep_fryer","holographic"}
