from . import centerline, crystal, deep_fryer, glitch, holographic_space, mosaic, ripple, shattered, shear, spiral, voronoi, wave
...
MODULES={
    ...
    "deep_fryer":deep_fryer,"holographic_space":holographic_space,
}
ALIASES={"tessellation":"crystal","triangles":"crystal","topographic":"ripple","xenoglyph":"shattered","alien":"shattered"}
FULL_PALETTE_FILTERS={"wave","voronoi","shear","spiral","mosaic","crystal","ripple","glitch","shattered","deep_fryer","holographic_space"}
