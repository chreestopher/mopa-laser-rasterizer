...
DOCS = {
    ...
    "laser-compatibility": _page(
        ...
        ], ["color-discovery", "works-with-lightburn", "mopa-laser-workflow", "holographic-calibration"]),
    "color-discovery": _page(
        ...
        ], ["laser-compatibility", "material-libraries", "color-layers", "holographic-calibration"]),
    "job-history": _page(
...
DOC_GROUPS = [
    ...
    ("Lightburn and materials", ["works-with-lightburn", "laser-compatibility", "color-discovery", "material-vault", "material-libraries", "lightburn-export", "lightburn-large-projects", "reduce-lightburn-object-count", "mopa-laser-workflow"]),
