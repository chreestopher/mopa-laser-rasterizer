...
DOCS = {
    ...
    "laser-compatibility": _page(
        ...
        ], ["works-with-lightburn", "mopa-laser-workflow", "color-layers", "holographic-calibration"]),
    "job-history": _page(
...
DOC_GROUPS = [
    ...
    ("Lightburn and materials", ["works-with-lightburn", "laser-compatibility", "material-vault", "material-libraries", "lightburn-export", "lightburn-large-projects", "reduce-lightburn-object-count", "mopa-laser-workflow"]),
