...
export SERVERLESS_PANEL_FARGATE_CPU="${SERVERLESS_PRODUCTION_PANEL_FARGATE_CPU:-4096}"
export SERVERLESS_PANEL_FARGATE_MEMORY="${SERVERLESS_PRODUCTION_PANEL_FARGATE_MEMORY:-8192}"
export SERVERLESS_PANEL_PROCESSES="${SERVERLESS_PRODUCTION_PANEL_PROCESSES:-4}"
